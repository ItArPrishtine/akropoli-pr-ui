...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-account-account-module"], {
      ...
      _document) {
        ...
        */
        function (portal) {
          ...
          _get((_thisSuper = _assertThisInitialized(_this28), _getPrototypeOf(DomPortalOutlet.prototype)), "setDisposeFn", _thisSuper).call(_thisSuper,
          /**
          * @return {?}
          */
          function () {
      ...
      _document) {
        ...
        */
        function (portal) {
          ...
          _get((_thisSuper2 = _assertThisInitialized(_this31), _getPrototypeOf(CdkPortalOutlet.prototype)), "setDisposeFn", _thisSuper2).call(_thisSuper2,
          /**
          * @return {?}
          */
          function () {
  ...
  function node_modulesAngularMaterial__ivy_ngcc__Fesm2015MenuJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var MatMenuItem = /*#__PURE__*/function (_MatMenuItemMixinBase2) {
      ...
      var _super14 = _createSuper(MatMenuItem);
      ...
      function MatMenuItem(_elementRef, document, _focusMonitor, _parentMenu) {
        ...
        _this50 = _super14.call(this);
        _this50._elementRef = _elementRef;
        _this50._focusMonitor = _focusMonitor;
        _this50._parentMenu = _parentMenu;
        /**
         * ARIA role for the menu item.
         */

        _this50.role = 'menuitem';
        /**
         * Stream that emits when the menu item is hovered.
         */

        _this50._hovered = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Stream that emits when the menu item is focused.
         */

        _this50._focused = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        /**
         * Whether the menu item is highlighted.
         */

        _this50._highlighted = false;
        /**
         * Whether the menu item acts as a trigger for a sub-menu.
         */

        _this50._triggersSubmenu = false;

        if (_focusMonitor) {
          // Start monitoring the element so it gets the appropriate focused classes. We want
          // to show the focus style for menu items only when the focus was not caused by a
          // mouse or touch interaction.
          _focusMonitor.monitor(_this50._elementRef, false);
        }

        if (_parentMenu && _parentMenu.addItem) {
          _parentMenu.addItem(_assertThisInitialized(_this50));
        }

        _this50._document = document;
        return _this50;
      }
      /**
    ...
    var _MatMenuBase = /*#__PURE__*/function () {
      ...
      _createClass(_MatMenuBase, [{
        ...
        value: function ngAfterContentInit() {
          ...
          */
          function () {
            return _this51.closed.emit('tab');
          ...
          */
          function (focusedItem) {
            return _this51._keyManager.updateActiveItem(focusedItem);
          });
        }
        /**
         * @return {?}
        ...
        value: function focusFirstItem() {
          ...
          if (this.lazyContent) {
            ...
            */
            function () {
              return _this52._focusFirstItem(origin);
            });
          } else {
        ...
        value: function _updateDirectDescendants() {
          ...
          */
          function (items) {
            _this53._directDescendantItems.reset(items.filter(
            /**
            * @param {?} item
            * @return {?}
            */
            function (item) {
              return item._parentMenu === _this53;
            }));

            _this53._directDescendantItems.notifyOnChanges();
          });
        }
      }, {
        key: "xPosition",
        ...
        set: function set(classes) {
          ...
          if (previousPanelClass && previousPanelClass.length) {
            ...
            */
            function (className) {
              _this54._classList[className] = false;
            });
          }
          ...
          if (classes && classes.length) {
            ...
            */
            function (className) {
              _this54._classList[className] = true;
            });
    ...
    var MatMenu = /*#__PURE__*/function (_MatMenuBase2) {
      ...
      var _super15 = _createSuper(MatMenu);
    ...
    var _MatMenu = /*#__PURE__*/function (_MatMenu2) {
      ...
      var _super16 = _createSuper(_MatMenu);
      ...
      function _MatMenu(elementRef, ngZone, defaultOptions) {
        ...
        return _super16.call(this, elementRef, ngZone, defaultOptions);
      }
    ...
    var MatMenuTrigger = /*#__PURE__*/function () {
      ...
      function MatMenuTrigger(_overlay, _element, _viewContainerRef, scrollStrategy, _parentMenu, _menuItemInstance, _dir, _focusMonitor) {
        ...
        */
        function () {
          return _this55._openedBy = 'touch';
      ...
      _createClass(MatMenuTrigger, [{
            ...
            if (menu.lazyContent) {
              ...
              */
              ...
              Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(menu.lazyContent._attached)).subscribe({
                ...
                */
                function complete() {
                  return _this57._setIsMenuOpen(false);
                }
              });
            } else {
          ...
          if (this.menu.setPositionClasses) {
            ...
            */
            function (change) {
              ...
              /** @type {?} */
              _this58.menu.setPositionClasses(posX, posY);
            });
          }
        }
        /**
        ...
        value: function _setPosition(positionStrategy) {
          var _ref3 = this.menu.xPosition === 'before' ? ['end', 'start'] : ['start', 'end'],
              _ref4 = _slicedToArray(_ref3, 2),
              originX = _ref4[0],
              originFallbackX = _ref4[1];

          var _ref5 = this.menu.yPosition === 'above' ? ['bottom', 'top'] : ['top', 'bottom'],
              _ref6 = _slicedToArray(_ref5, 2),
              overlayY = _ref6[0],
              overlayFallbackY = _ref6[1];
        ...
        value: function _menuClosingActions() {
          ...
          */
          function (active) {
            return active !== _this59._menuItemInstance;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])(
          /**
          * @return {?}
          */
          function () {
            return _this59._menuOpen;
        ...
        value: function _handleHover() {
          ...
          */
          function (active) {
            return active === _this60._menuItemInstance && !active.disabled;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(0, rxjs__WEBPACK_IMPORTED_MODULE_4__["asapScheduler"])).subscribe(
          /**
          * @return {?}
          */
          function () {
            _this60._openedBy = 'mouse'; // If the same menu is used between multiple triggers, it might still be animating
            // while the new trigger tries to re-open it. Wait for the animation to finish
            // before doing so. Also interrupt if the user moves to another item.

            if (_this60.menu instanceof MatMenu && _this60.menu._isAnimating) {
              // We need the `delay(0)` here in order to avoid
              // 'changed after checked' errors in some cases. See #12194.
              _this60.menu._animationDone.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["delay"])(0, rxjs__WEBPACK_IMPORTED_MODULE_4__["asapScheduler"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(_this60._parentMenu._hovered())).subscribe(
              /**
              * @return {?}
              */
              function () {
                return _this60.openMenu();
              });
            } else {
              _this60.openMenu();
            }
        ...
        set: function set(menu) {
          ...
          if (menu) {
            ...
            */
            function (reason) {
              _this61._destroyMenu(); // If a click closed the menu, we should close the entire chain of nested menus.


              if ((reason === 'click' || reason === 'tab') && _this61._parentMenu) {
                _this61._parentMenu.closed.emit(reason);
              }
            });
          }
        }
    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | account-management-account-management-module */
          [__webpack_require__.e("default~account-management-account-management-module~biblioteka-biblioteka-module~modules-authentica~8d9ba643"), __webpack_require__.e("default~account-management-account-management-module~biblioteka-biblioteka-module"), __webpack_require__.e("account-management-account-management-module")]).then(__webpack_require__.bind(null,
          /*! ./account-management/account-management.module */
          "./src/app/modules/account/account-management/account-management.module.ts")).then(function (mod) {
            return mod.AccountManagementModule;
          });
        }
      }, {
        ...
        loadChildren: function loadChildren() {
          return Promise.all(
          /*! import() | biblioteka-biblioteka-module */
          [__webpack_require__.e("default~account-management-account-management-module~biblioteka-biblioteka-module~modules-authentica~8d9ba643"), __webpack_require__.e("default~account-management-account-management-module~biblioteka-biblioteka-module"), __webpack_require__.e("biblioteka-biblioteka-module")]).then(__webpack_require__.bind(null,
          /*! ./biblioteka/biblioteka.module */
          "./src/app/modules/account/biblioteka/biblioteka.module.ts")).then(function (mod) {
            return mod.BibliotekaModule;
          });
        }
      }]
    }];
  ...
  function srcAppModulesAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AccountModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _account_routing_module__WEBPACK_IMPORTED_MODULE_3__["AccountRoutingModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_5__["_MatMenuDirectivesModule"], _angular_material_button__WEBPACK_IMPORTED_MODULE_6__["MatButtonModule"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_5__["MatMenuModule"]]]
    });
  ...
  /***/
  function srcAppModulesAccountHeaderHeaderComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_constants_RouterUrls__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ../../../shared/constants/RouterUrls */
    "./src/app/shared/constants/RouterUrls.ts");
    /* harmony import */
    ...
    HeaderComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 24,
      vars: 1,
      consts: [[1, "header-fixed"], [1, "left-side"], [1, "logo-plc"], ["href", "#"], ["src", "/assets/images/logo.png"], [1, "right-side"], ["href", "#", 1, "selected"], [1, "profile-avatar"], [1, "open-menu"], [1, "image", 2, "background-image", "url(\"/assets/images/img_avatar.png\")", 3, "matMenuTriggerFor"], ["menu", "matMenu"], ["mat-menu-item", ""], ["mat-menu-item", "", 3, "click"]],
      ...
      directives: [_angular_material_menu__WEBPACK_IMPORTED_MODULE_3__["MatMenuTrigger"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_3__["_MatMenu"], _angular_material_menu__WEBPACK_IMPORTED_MODULE_3__["MatMenuItem"]],
